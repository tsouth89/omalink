...
assert.equal(model.thumbnailUri({ thumbnail: "abc123" }), "data:image/png;base64,abc123")
...
assert.equal(model.notificationDisplayTitle(redacted), "New message")
...
assert.equal(model.notificationDisplayText(redacted), "")
